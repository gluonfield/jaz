...
export function QwenMark({ style, className }: { style?: CSSProperties; className?: string }) {
  return (
    <svg viewBox="0 0 141.38 140" style={style} className={className} fill="currentColor" aria-hidden="true">
