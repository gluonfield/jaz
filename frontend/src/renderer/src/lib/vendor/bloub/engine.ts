import { arcRender, type ArcRender, type DotRender } from '@/lib/vendor/bloub/decor'
import { blendExpression, type BotExpression } from '@/lib/vendor/bloub/expressions'
import { decalageDesYeux } from '@/lib/vendor/bloub/eyefit'
import { blinkScale, eyePoses, liveliness } from '@/lib/vendor/bloub/face'
import { clamp, easings, lerp, r2 } from '@/lib/vendor/bloub/math'
import {
  blend,
  capsulePath,
  closedPath,
  ...
  type Point,
  type Silhouette
} from '@/lib/vendor/bloub/shape'
import { STATE_BY_ID, type Pose, type StateDef, type StateId } from '@/lib/vendor/bloub/states'
