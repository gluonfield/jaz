import {
  ...
  type ArcSpec,
  type DotRender
} from '@/lib/vendor/bloub/decor'
import { EYE_H, EYE_SPLIT, EYE_W, REST_GAZE, type HeadGaze } from '@/lib/vendor/bloub/face'
import { TAU, clamp, easings } from '@/lib/vendor/bloub/math'
import {
  circle,
  hullOfCircles,
  polyPath,
