...
func TestUnifiedServerMemoryAndLoopTools(t *testing.T) {
	...
	for _, name := range []string{
		...
		"thread_context",
		"gmail_get_profile", "gmail_search_threads", "gmail_read_thread", "gmail_create_draft", "gmail_create_reply_draft", "gmail_send_draft", "gmail_update_draft", "gmail_list_drafts",
