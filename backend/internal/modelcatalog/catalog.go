...
var (
	...
	agentModels = map[string][]Model{
		...
		"claude": {
			...
			{Value: "sonnet", Label: "Sonnet 4.6", Description: "Efficient for routine tasks", ContextLength: 200000, OpenRouterID: "anthropic/claude-sonnet-4.6", ReasoningEfforts: claudeStandardThinkingEfforts},
			{Value: "sonnet[1m]", Label: "Sonnet 4.6 (1M context)", Description: "Draws from usage credits", ContextLength: 1000000, OpenRouterID: "anthropic/claude-sonnet-4.6", ReasoningEfforts: claudeStandardThinkingEfforts},
