...
<img width="280" height="60" alt="download-macos" src="https://github.com/user-attachments/assets/1a702cd1-fe55-4ed0-ab99-4e42ca4d4c8f" /><svg xmlns="http://www.w3.org/2000/svg" width="280" height="60" viewBox="0 0 280 60" role="img" aria-label="Download for macOS">
  ...
  <text x="70" y="27" font-family="-apple-system,'SF Pro Display','Helvetica Neue',Arial,sans-serif" font-size="17" font-weight="600" fill="#ffffff">Download for macOS</text>
  <text x="70" y="43" font-family="-apple-system,'SF Pro Text','Helvetica Neue',Arial,sans-serif" font-size="11" fill="#a1a1a6" letter-spacing="0.2">Apple Silicon</text>
</svg>
